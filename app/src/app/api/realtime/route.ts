...
export const GET = apiHandler(async (req) => {
  ...
  return ok({
    ...
    channels: [
      ...
      {
        name: "market:{pubkey}",
        description: "Per-market updates (trades, price changes)",
      },
      {
        name: "user:{wallet}",
        description: "Personal notifications and position updates",
      },
      {
        name: "admin",
        description: "Admin-only events (settlements, fee withdrawals)",
      },
    ],
