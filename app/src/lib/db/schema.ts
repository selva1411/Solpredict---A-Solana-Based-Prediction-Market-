...
export const marketsCache = pgTable(
  "markets_cache",
  {
    ...
    feeCollectedLamports: bigint("fee_collected_lamports", {
      mode: "number",
    }).default(0),
    totalPayoutPoolLamports: bigint("total_payout_pool_lamports", {
      mode: "number",
    }).default(0),
    ...
    totalVolume: decimal("total_volume", { precision: 18, scale: 9 }).default(
      "0"
    ),
    openInterest: decimal("open_interest", { precision: 18, scale: 9 }).default(
      "0"
    ),
...
export const marketOutcomes = pgTable(
  "market_outcomes",
  {
    ...
    sharesOutstanding: bigint("shares_outstanding", { mode: "number" }).default(
      0
    ),
...
export const priceHistory = pgTable(
  ...
  (t) => ({
    marketTsIdx: index("price_history_market_ts_idx").on(
      t.marketPubkey,
      t.timestamp
    ),
  })
...
export const liquidityPositions = pgTable(
  "liquidity_positions",
  {
    id: serial("id").primaryKey(),
    wallet: varchar("wallet", { length: 44 }).notNull(),
    ...
    feesEarned: decimal("fees_earned", { precision: 18, scale: 9 }).default(
      "0"
    ),
    createdAt: timestamp("created_at").defaultNow(),
    updatedAt: timestamp("updated_at").defaultNow(),
...
export const marketProposals = pgTable(
  ...
  {
    id: serial("id").primaryKey(),
    proposalPubkey: varchar("proposal_pubkey", { length: 44 })
      .unique()
      .notNull(),
...
export const userStats = pgTable("user_stats", {
  ...
  realizedPnl: decimal("realized_pnl", { precision: 18, scale: 9 }).default(
    "0"
  ),
  unrealizedPnl: decimal("unrealized_pnl", { precision: 18, scale: 9 }).default(
    "0"
  ),
...
export const lpPoolStats = pgTable("lp_pool_stats", {
  id: serial("id").primaryKey(),
  marketPubkey: varchar("market_pubkey", { length: 44 }).unique().notNull(),
  totalLiquiditySol: decimal("total_liquidity_sol", {
    precision: 18,
    scale: 9,
  }).default("0"),
  totalLpTokens: bigint("total_lp_tokens", { mode: "number" }).default(0),
  feeEarnedSol: decimal("fee_earned_sol", { precision: 18, scale: 9 }).default(
    "0"
  ),
  updatedAt: timestamp("updated_at").defaultNow(),
});
