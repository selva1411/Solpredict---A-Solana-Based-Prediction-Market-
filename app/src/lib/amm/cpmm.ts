 ...
 */
export function getSpotPriceYes(
  poolYes: bigint,
  poolNo: bigint,
  _feeBps: number
): bigint {
...
export function getSpotPriceNo(
  poolYes: bigint,
  poolNo: bigint,
  _feeBps: number
): bigint {
 ...
 */
export function buyCostLamports(
  p: PoolState,
  side: "YES" | "NO",
  dyOut: bigint
): bigint {
 ...
 */
export function sellRefundLamports(
  p: PoolState,
  side: "YES" | "NO",
  dyIn: bigint
): bigint {
  if (side === "YES")
    return getSellAmountOut(p.poolYes, p.poolNo, dyIn, p.feeBps);
